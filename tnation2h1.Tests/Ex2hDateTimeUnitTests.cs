...
namespace tnation2h1.Tests
{
    ...
    public class Ex2hDateTimeUnitTests
    {
        ...
        {
            Assert.AreEqual("31.00:00:00 days", Ex2hCalculations.DateCalc09("2/1/2000", "1/1/2000"));
        }
        [TestMethod]
        ...
        {
            Assert.AreEqual("31.00:00:00 days past due", Ex2hCalculations.DateCalc10("2/1/2000", "1/1/2000"));
        }
        [TestMethod]
