<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="tnation2h1._Default" %>
    ...
    <div class="row">
        <div class="col-md-6">
            <h2>DateTime Methods</h2>
                ...
                <div class="form-group">
                    <asp:Label ID="Label6" runat="server" Text="6) DateTime.Parse(): "></asp:Label>    
        ...
        <div class="col-md-6">
            <h2>String Methods</h2>
                ...
                <div class="form-group">
                    <asp:Label ID="Label12" runat="server" Text="2) Remove/Inset: "></asp:Label>    
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="TextBox19" runat="server" Width="220px">111 1st St, Lake City, MN 55041</asp:TextBox>
